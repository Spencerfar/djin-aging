...
loss_file = '%svalidation%d_sample.loss'%(output_folder, args.job_id)
open(loss_file, 'w')

# output hyperparameters
hyperparameters_file = '%strain%d_sample.hyperparams'%(output_folder, args.job_id)
...
train_name = 'Data/train_sample.csv'
...
valid_name = 'Data/train_sample.csv'
...
for epoch in range(niters):
    ...
    # output params
    if epoch % 20 ==0:
        torch.save(model.state_dict(), '%strain%d_Model_DJIN_epoch%d_sample.params'%(params_folder, args.job_id, epoch))
